...
Uses httpx to POST JSON-RPC tool-call requests to the MCP server's
streamable-http endpoint. Handles both JSON and SSE response bodies.
"""
...
_ALLOWED_TABLES = ("trans_log", "pom_acr", "user_profile", "user_journey")
...
# ---------------------------------------------------------------------------
# TOOL_REGISTRY replacement — same interface as the old local registry
# ---------------------------------------------------------------------------
